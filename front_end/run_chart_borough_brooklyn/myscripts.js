...
$().ready(function(){   
    ...
    var bronx_green = "./Result_trip_num/borough_bronx/green_Bronx";
    var bronx_yellow = "./Result_trip_num/borough_bronx/Yellow_Bronx";
    var bronx_uber = "./Result_trip_num/borough_bronx/Uber_Bronx";

    var addr_green =brooklyn_green;
    var addr_yellow =brooklyn_yellow;
    var addr_uber =brooklyn_uber;
